...
/**
 * Implements tests for the {@link ResourceProviderRegionRoute} class.
 *
 * @author matthi-g
 */
public class ResourceProviderRegionRouteTest extends RouterTest {

    @Test
    void listResourceProviderRegions(Vertx vertx, VertxTestContext testContext) {
        WebClient client = WebClient.create(vertx);
        client.get(API_PORT, API_URL, "/api/resource-providers/1/regions")
