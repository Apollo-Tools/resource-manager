...
public class PrivateEntityResultHandlerTest {

    private PrivateEntityResultHandler resultHandler;
    ...
    @BeforeEach
    void initTest() {
        resultHandler = new PrivateEntityResultHandler(validationHandler);
    }
    ...
    void handleFindOneRequestValid(boolean useCustomHandler, VertxTestContext testContext) {
        ...
        if (useCustomHandler) {
            ...
            when(validationHandler.getOneFromAccount(rc)).thenReturn(handler);
    ...
    void handleFindAllRequestValid(boolean useCustomHandler, VertxTestContext testContext) {
        ...
        if (useCustomHandler) {
            ...
            when(validationHandler.getAllFromAccount(rc)).thenReturn(handler);
    ...
    void handlePostOneRequestValid(VertxTestContext testContext) {
        ...
        when(validationHandler.postOneToAccount(rc)).thenReturn(handler);
    ...
    void handlePostAllUpdateDeleteRequest(String method, int statusCode, VertxTestContext testContext) {
        ...
        switch(method) {
            ...
            case "update":
                ...
                break;
            case "delete":
                when(validationHandler.deleteOneFromAccount(rc)).thenReturn(handler);
