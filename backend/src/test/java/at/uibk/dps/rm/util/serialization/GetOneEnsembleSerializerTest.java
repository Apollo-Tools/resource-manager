...
public class GetOneEnsembleSerializerTest {
    ...
    public void serialize() {
        ...
        assertThat(result.encode()).isEqualTo("{\"ensemble_id\":1,\"name\":\"ensemble\",\"resources\":[" +
                ...
                "\"resource_provider\":{\"provider_id\":1,\"provider\":\"aws\",\"created_at\":null}," +
                "\"created_at\":null},\"metric_values\":null,\"is_self_managed\":false},{\"resource_id\":2," +
                "\"created_at\":null,\"updated_at\":null,\"resource_type\":{\"type_id\":1," +
                "\"resource_type\":\"cloud\",\"created_at\":null},\"region\":{\"region_id\":1,\"name\":\"us-east-1\"," +
                "\"resource_provider\":{\"provider_id\":1,\"provider\":\"aws\",\"created_at\":null}," +
                "\"created_at\":null},\"metric_values\":null,\"is_self_managed\":false}]," +
                "\"slos\":[{\"name\":\"availability\",\"expression\":\">\",\"value\":[0.8]}," +
