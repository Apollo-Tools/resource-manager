...
public class GetOneEnsembleSerializerTest {
    ...
    void serialize() {
        ...
        assertThat(result.encode()).isEqualTo("{\"ensemble_id\":1,\"name\":\"ensemble\",\"resources\":" +
            ...
            "null,\"created_at\":null},\"created_at\":null},\"platform\":null,\"sub_resources\":[]},{\"resource_id\":" +
            "2,\"name\":\"mainresource2\",\"is_lockable\":false,\"created_at\":null,\"updated_at\":null," +
            "\"metric_values\":[{\"metric_value_id\":1,\"count\":10,\"value_string\":\"t1.micro\",\"value_bool\":" +
            "null,\"metric\":{\"metric_id\":3,\"metric\":\"instance-type\",\"description\":\"Blah\",\"is_slo\":null," +
            "\"metric_type\":{\"metric_type_id\":2,\"type\":\"string\"},\"created_at\":null},\"created_at\":null," +
            "\"updated_at\":null}],\"region\":{\"region_id\":2,\"name\":\"us-west-1\",\"resource_provider\":" +
            ...
            "{\"type_id\":11,\"resource_type\":\"faas\",\"created_at\":null},\"created_at\":null},\"sub_resources\":" +
            "[]}],\"created_at\":null,\"updated_at\":null,\"slos\":[{\"name\":\"timeout\",\"expression\":\">\"," +
            "\"value\":[150.0]},{\"name\":\"resource_type\",\"expression\":\"==\",\"value\":[5.0]},{\"name\":" +
            "\"platform\",\"expression\":\"==\",\"value\":[3.0,4.0]},{\"name\":\"resource_provider\",\"expression\":" +
            "\"==\",\"value\":[5.0]}]}");
    }
}
