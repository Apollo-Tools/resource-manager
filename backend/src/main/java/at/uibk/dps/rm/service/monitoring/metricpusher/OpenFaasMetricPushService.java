...
@ProxyGen
@VertxGen
public interface OpenFaasMetricPushService extends ServiceInterface {

    @SuppressWarnings("PMD.CommentRequired")
    @Generated
    @GenIgnore
    static OpenFaasMetricPushService create(WebClient webClient, ConfigDTO config) {
        return new OpenFaasMetricPushServiceImpl(webClient, config);
    }

    @SuppressWarnings("PMD.CommentRequired")
    @Generated
    static OpenFaasMetricPushService createProxy(Vertx vertx) {
        return new OpenFaasMetricPushServiceVertxEBProxy(vertx, ServiceProxyAddress.getServiceProxyAddress(
            "openfaas-metric-pusher"));
    }
