...
import at.uibk.dps.rm.rx.service.database.util.K8sResourceUpdateUtility;
import at.uibk.dps.rm.rx.service.database.util.SLOUtility;
...
public class ResourceServiceImpl extends DatabaseServiceProxy<Resource> implements ResourceService {
    ...
    public void findAll(Handler<AsyncResult<JsonArray>> resultHandler) {
        ...
        handleSession(findAll.map(this::encodeResourceList), resultHandler);
    }
    ...
    public void updateClusterResource(String clusterName, K8sMonitoringData data,
        ...
        handleSession(updateClusterResource, resultHandler);
    }
