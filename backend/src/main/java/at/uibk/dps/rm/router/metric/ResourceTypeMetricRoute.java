...
import at.uibk.dps.rm.handler.metric.ResourceTypeMetricRequestHandler;
...
public class ResourceTypeMetricRoute {
    public static void init(RouterBuilder router, ServiceProxyProvider serviceProxyProvider) {
        ...
        RequestHandler requestHandler = new ResourceTypeMetricRequestHandler(handler);

        router
            .operation("getResourceTypeMetrics")
